	...
	searchByColor : function(color_upbody, color_downbody, onSuccess){
		...
		$.ajax({
			...
			success: function(data){
				mainController.popup("Thanks for the feedback");
				onSuccess(data);
			},
			error: function(){
			mainController.popup("Error Occur!");
...
//        });
	...
	feedback : function(str_keyword,str_fb,str_category,str_id,str_name,str_features){
		var url="feedback.do"
		$.ajax({
			url: url,
			type: "post",
